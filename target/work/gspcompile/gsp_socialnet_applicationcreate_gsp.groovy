...
class gsp_socialnet_applicationcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/application/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(12)
invokeTag('renderErrors','g',23,['bean':(applicationInstance),'as':("list")],-1)
printHtmlPart(13)
})
invokeTag('hasErrors','g',25,['bean':(applicationInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(14)
...
printHtmlPart(16)
invokeTag('textField','g',36,['name':("api"),'value':(applicationInstance?.api)],-1)
printHtmlPart(17)
invokeTag('message','g',42,['code':("application.name.label"),'default':("Name")],-1)
printHtmlPart(15)
expressionOut.print(hasErrors(bean: applicationInstance, field: 'name', 'errors'))
printHtmlPart(16)
invokeTag('textField','g',45,['name':("name"),'value':(applicationInstance?.name)],-1)
printHtmlPart(18)
