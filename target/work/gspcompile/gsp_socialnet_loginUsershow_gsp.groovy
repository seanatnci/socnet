...
class gsp_socialnet_loginUsershow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loginUser/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('message','g',26,['code':("loginUser.id.label"),'default':("Id")],-1)
printHtmlPart(13)
...
printHtmlPart(14)
invokeTag('message','g',40,['code':("loginUser.password.label"),'default':("Password")],-1)
printHtmlPart(13)
expressionOut.print(fieldValue(bean: loginUserInstance, field: "password"))
printHtmlPart(15)
createTagBody(2, {->
printHtmlPart(16)
invokeTag('hiddenField','g',51,['name':("id"),'value':(loginUserInstance?.id)],-1)
printHtmlPart(17)
invokeTag('actionSubmit','g',52,['class':("edit"),'action':("edit"),'value':(message(code: 'default.button.edit.label', default: 'Edit'))],-1)
printHtmlPart(18)
